            ...
            for(int32_t i1=0; i1<BLOCK_OUT; i1++){
                for(int32_t j0=0; j0<K/BLOCK_IN; j0++){
                    for(int32_t j1=0; j1<BLOCK_IN; j1++){
                        tS[m*N/BLOCK_OUT*BLOCK_OUT + i0*BLOCK_OUT + i1] += (int32_t) gA[m*K/BLOCK_IN*BLOCK_IN + j0*BLOCK_IN + j1] * (int32_t)gB[i0*K/BLOCK_IN*BLOCK_OUT*BLOCK_IN + j0*BLOCK_OUT*BLOCK_IN + i1*BLOCK_IN+j1];
                    }
                }
            }
        }
